...
export interface components {
	schemas: {
		...
		ApplianceModelAndParams:
			| components["schemas"]["ApplianceModelAndParam"][]
			| null;
		ApplianceModelUnion:
			| (
					| components["schemas"]["ApplianceModel"]
					| components["schemas"]["ApplianceTVModel"]
					| components["schemas"]["ApplianceLightModel"]
					| components["schemas"]["ApplianceELModel"]
					| components["schemas"]["ApplianceLightProjectorModel"]
					| components["schemas"]["ApplianceFloorHeaterModel"]
					| components["schemas"]["BLEModel"]
			  )
			| null;
		ApplianceResponse: {
		...
		BLEPrivateMacroResponses:
			| components["schemas"]["BLEPrivateMacroResponse"][]
			| null;
		...
		DeviceResponse: {
			...
			commissionee_fabrics?:
				| components["schemas"]["DeviceCommissioneeFabricResponse"][]
				| null;
		...
		Home: {
			breaker_capacity?:
				| components["schemas"]["CoreHomeBreakerCapacity"]
				| null;
			id: string;
			name: string;
		};
		...
		MorninPlusResponse: {
			devices:
				| (components["schemas"]["MorninPlusDeviceResponse"] | null)[]
				| null;
		...
		SmartMeterResponse: {
			echonetlite_properties:
				| (components["schemas"]["ELPropertyResponse"] | null)[]
				| null;
		};
		TVParams: {
			/** @description Button name. */
		...
		UserResponse: {
			...
			updated_privacy_policy?:
				| components["schemas"]["PrivacyPolicyRevisionOutline"]
				| null;
		};
	};
	responses: never;
